    ...
    <>
      ...
      >
        ...
        <div className="flex-shrink-0 relative" style={{ borderBottom: `1px solid ${S.sidebarBorder}` }}>
          ...
          {/* Expanded */}
          <div className="px-5 py-5 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-150">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            ...
            <p className="text-xs font-semibold truncate" style={{ color: S.textLight }}>{companyName}</p>
