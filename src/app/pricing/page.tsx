...
const pricingSchema = {
  ...
  offers: [
    ...
    },
    {
      ...
      price: '2499',
      priceCurrency: 'ZAR',
      description: 'For established firms and high-volume studios. Up to 10 team members, Sage integration, custom branded PDFs.',
      eligibleCustomerType: 'https://schema.org/Business',
    },
  ],
}
...
const plans = [
  ...
  },
  {
    ...
    tagline: 'Full team. Full integration.',
    features: [
