...
export default async function SourcingDetailPage({
  ...
  const enrichedSuppliers = (sessionSuppliers ?? []).map((ss: any) => {
    ...
    return {
      ...
      status: ss.status,
      sent_at: ss.sent_at,
      installation_fee: ss.installation_fee ?? null,
      delivery_fee: ss.delivery_fee ?? null,
      installation_pushed_project_id: ss.installation_pushed_project_id ?? null,
      delivery_pushed_project_id: ss.delivery_pushed_project_id ?? null,
