...
export default function CapitalPortalPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F2EC]">
      ...
      {/* Sticky footer */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#E8E4DC] p-4 shadow-[0_-4px_24px_rgba(0,0,0,0.06)]">
        {error && (
