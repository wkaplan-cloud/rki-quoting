...
export default function DesignerVsDecoratorSouthAfrica() {
  return (
    <article className="prose-content">
      ...
      <h2>Qualifications and professional registration in South Africa</h2>

      <h3>Interior designers — formal qualifications and IID registration</h3>
      <p>
        Interior design in South Africa is not a legally protected profession in the same way that architecture is (architecture is regulated by SACAP — the South African Council for the Architectural Profession). However, the professional body for interior design is the <strong>Institute of Interior Design Professions (IID)</strong>, which sets standards and registers members.
      </p>
      <p>IID membership categories include:</p>
      <ul>
        <li><strong>Professional Interior Designer (PrID):</strong> Requires a recognised tertiary qualification (typically a 3–4 year degree or diploma in interior design), plus a minimum of 2 years of professional experience and completion of an IID assessment.</li>
        <li><strong>Interior Design Practitioner (IDP):</strong> For practitioners with recognised qualifications but fewer years of experience.</li>
        <li><strong>Interior Decorator:</strong> IID also registers decorators — practitioners focused on the decorative layer without spatial design qualifications.</li>
      </ul>
      <p>
      ...
      <h3>Interior decorators — no mandatory registration</h3>
      <p>
      ...
      <h2>What each professional does</h2>

      <h3>What interior designers do</h3>
      <ul>
        <li>Space planning and floor plan development</li>
        <li>Lighting design (position, type, and electrical specification)</li>
        <li>Specification of built-in joinery, cabinetry, and millwork</li>
        <li>Coordination with architects, structural engineers, and contractors</li>
        <li>Material and finish specifications for floors, walls, ceilings</li>
        <li>Compliance checking (fire egress, accessibility, building regulations)</li>
        <li>Furniture and décor selection and procurement</li>
        <li>Project management from concept through handover</li>
      </ul>

      <h3>What interior decorators do</h3>
      <ul>
        <li>Colour scheme and palette development</li>
        <li>Furniture selection and layout within an existing space</li>
        <li>Fabric and soft furnishing specification</li>
        <li>Accessories, art, and styling</li>
        <li>Window treatments and soft goods</li>
        <li>Supplier sourcing and procurement</li>
        <li>Styling for photography or staging for property sales</li>
      </ul>

      <h2>Which professional do you need for your project?</h2>
      <p>
        If your project involves any of the following, you need an interior designer (and likely an architect as well):
      </p>
      <ul>
        <li>Moving or removing walls</li>
        <li>Changing the floor plan layout</li>
        <li>New lighting circuit design</li>
        <li>Bathroom or kitchen plumbing repositioning</li>
        <li>Commercial fit-outs with compliance requirements</li>
        <li>New builds where interior design input is needed at the architectural stage</li>
      </ul>
      <p>
      ...
      <p>
        For guidance on building professional quotations for either type of practice, see our guides on <Link href="/blog/how-to-write-interior-design-quotation-south-africa" className="text-[#9A7B4F] hover:underline">how to write an interior design quotation</Link> and <Link href="/blog/interior-design-fee-structure-south-africa" className="text-[#9A7B4F] hover:underline">how to structure your fees as a South African designer</Link>.
      </p>

      <h2>Frequently asked questions</h2>

      <h3>Is interior design a protected profession in South Africa?</h3>
      <p>
      ...
      <h3>Can an interior decorator legally call themselves an interior designer?</h3>
      <p>
      ...
      <h3>Do I need a registered interior designer for my renovation project?</h3>
      <p>
      ...
      <h3>What qualifications do I need to become an interior designer in South Africa?</h3>
      <p>
      ...
      <div className="cta-block">
        <p className="cta-heading">Built for designers and decorators alike.</p>
        <p className="cta-body">QuotingHub handles your quotes, invoices, and purchase orders — whatever your title. 30-day free trial, no credit card needed.</p>
