...
export default function VatOnInteriorDesignSouthAfrica() {
  return (
    <article className="prose-content">
      ...
      <h2>Do interior designers need to register for VAT in South Africa?</h2>
      <p>
        VAT registration in South Africa is governed by the Value-Added Tax Act (89 of 1991). The rule is straightforward:
      </p>
      <ul>
        <li><strong>Compulsory registration:</strong> If your taxable turnover exceeds or is reasonably expected to exceed <strong>R1 million in any 12-month period</strong>, you must register for VAT with SARS. This threshold applies to all taxable supplies — your design fees, product markups, and any other business income combined.</li>
        <li><strong>Voluntary registration:</strong> If your turnover is below R1 million but above R50,000 per year, you may voluntarily register for VAT. This can be advantageous if your main clients are VAT-registered businesses who can claim input tax — it makes you more competitive against VAT-registered suppliers.</li>
        <li><strong>Not required to register:</strong> If your turnover is below R1 million and you have not voluntarily registered, you must not charge VAT and must not include a VAT number on your invoices.</li>
      </ul>
      <p>
      ...
      <h2>What rate of VAT applies to interior design services?</h2>
      <p>
        The standard VAT rate in South Africa is <strong>15%</strong>, applicable since 1 April 2018. Interior design services are taxable supplies — they are not zero-rated or VAT-exempt. This means 15% VAT applies to:
      </p>
      <ul>
        <li>Your design fees</li>
        <li>Project management fees</li>
        <li>Product markups on furniture and materials</li>
        <li>Any other service or supply you make to clients</li>
      </ul>

      <h2>What do you charge VAT on?</h2>
      ...
      <h3>Product supply and markups</h3>
      <p>
      ...
      <h3>Disbursements and reimbursements</h3>
      <p>
      ...
      <ul>
        <li><strong>Principal (you are responsible for the expense):</strong> The recharge is taxable — you charge VAT on the full amount.</li>
        <li><strong>Agent (you paid on behalf of the client and are simply recovering the outlay):</strong> If structured correctly as a disbursement, no VAT applies to the recovery. Document this clearly.</li>
      </ul>
      <p>
        If in doubt, charge VAT — it is safer than failing to charge it when required.
      </p>

      <h2>VAT on deposits: when does VAT apply?</h2>
      <p>
        This is where many SA designers trip up. Under the VAT Act, VAT is triggered at the earlier of:
      </p>
      <ul>
        <li>The date you issue an invoice, or</li>
        <li>The date you receive payment</li>
      </ul>
      <p>
      ...
      <p>
        <strong>Practical example:</strong> You raise a quotation for R115,000 (incl. 15% VAT). The client pays a 50% deposit of R57,500. In that tax period, you must account for the VAT portion of R57,500, which is R57,500 × 15/115 = R7,500 in output VAT.
      </p>
      <p>
      ...
      <h2>How to issue a tax invoice as a VAT-registered interior designer</h2>
      <p>
      ...
      <ul>
        ...
        <li>The client&apos;s name, address, and VAT number (if they are VAT-registered)</li>
        <li>Description of the goods or services supplied</li>
        <li>The quantity and price per unit</li>
        <li>The VAT amount charged</li>
      ...
      <h2>What if your client is also VAT-registered?</h2>
      <p>
      ...
      <h3>What is the VAT threshold for interior designers in South Africa?</h3>
      <p>
      ...
      <h3>Do I charge VAT on a deposit from a client?</h3>
      <p>
      ...
      <h3>Can my clients claim back VAT on interior design fees?</h3>
      <p>
      ...
      <h3>What is the difference between a quotation and a tax invoice for VAT purposes?</h3>
      <p>
        A quotation is not a tax invoice and does not create a VAT liability. VAT only becomes due when you issue a tax invoice or receive payment — whichever is earlier. Sending a quote to a client does not trigger VAT. See our guide on <Link href="/blog/how-to-write-interior-design-quotation-south-africa" className="text-[#9A7B4F] hover:underline">how to write an interior design quotation</Link> for the full distinction.
      </p>

      <h3>Do I need an accountant to manage VAT as an interior designer?</h3>
      <p>
      ...
      <div className="cta-block">
        <p className="cta-heading">VAT calculated automatically.</p>
        <p className="cta-body">QuotingHub applies 15% VAT correctly on every quote, invoice, and deposit — so you never have to do the maths manually again.</p>
