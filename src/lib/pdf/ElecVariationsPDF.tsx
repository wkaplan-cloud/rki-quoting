...
export function ElecVariationsPDF({ quote, client, settings, variationOrders, lineItems = [], companyName, companyEmail, logoUrl, palette = BLUE_PALETTE }: Props) {
        ...
        <Page size="A4" style={s.page}>
          ...
          <View style={s.summaryRow}>
            {[
              ...
              { label: 'TOTAL VALUE',  val: fmtR(totalAll),       color: palette.accent },
            ].map(c => (
            ...
            <>
              ...
              {variationOrders.map((vo, i) => (
                ...
                <View style={[s.row, i % 2 !== 0 ? s.rowAlt : {}]} wrap={false}>
                  ...
                  <Text style={[s.td, { width: COL.value, paddingRight: GAP, textAlign: 'right', fontFamily: 'Helvetica-Bold', color: palette.accent }]}>{nbsp(fmtR(vo.value))}</Text>
