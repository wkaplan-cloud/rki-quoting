          ...
          <View style={{ marginBottom: 20 }}>
            ...
            {(() => {
              ...
              return lineItems.map(item => {
                ...
                return (
                  <View key={item.id} wrap={false} style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 6, paddingHorizontal: 6, borderBottomWidth: 0.5, borderBottomColor: theme.border }}>
