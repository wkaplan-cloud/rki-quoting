      ...
      <Page size="A4" style={{ fontFamily: 'Helvetica', fontSize: 9, color: theme.text, padding: 56, flexDirection: 'column' }}>
        <View style={{ flex: 1 }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 40 }}>
            <View>
              {logoUrl
                ? <Image src={logoUrl} style={{ maxWidth: 240, maxHeight: 56, objectFit: 'contain' }} />
          ...
          <View style={{ marginBottom: 28 }}>
            ...
            {(() => {
              ...
              return lineItems.map(item => {
                ...
                itemNum++
                return (
                  <View key={item.id} style={{ flexDirection: 'row', paddingVertical: 8, borderBottomWidth: 0.5, borderBottomColor: theme.border }}>
